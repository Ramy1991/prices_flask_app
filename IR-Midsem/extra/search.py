...
STOP_WORDS_FILENAME = r'E:\Pycharm\prices_flask_app\IR-Midsem\data\question_answer_pairs.txt'
...
class SearchEngine(object):
    ...
    def __load_stop_words(self):
        stop_words = {}
        with open(STOP_WORDS_FILENAME, encoding='ISO-8859-1') as stop_words_file:
